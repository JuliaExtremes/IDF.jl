function computeSimpleScalingStatistic(D_values::Vector{<:Real}, data::DataFrame, d_out::Real)
    ...
    IDF_model_one_out = SimpleScalingModel(D_values_one_out, d_ref = d_out)
...
struct TestSimpleScaling <: TestIDF
    ...
    function TestSimpleScaling(D_values::Vector{<:Real}, data::DataFrame;
        ...
        statistic = computeSimpleScalingStatistic(D_values, data, d_out)
